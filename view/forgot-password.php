            ...
            <div class="card border-grey border-lighten-3 m-0 box-shadow-0 card-account-right height-400">                
                <div class="card-content">                    
                    <div class="card-body login-p-3">
                        ...
                        <p class="mb-3 text-center">Please enter your email address</p>
                        <br><br>
                        <form class="form-horizontal form-signin" action="process-forgot.php" method="POST">
                            <input type="hidden" name="next" value="<?php echo $_GET['next'];?>" />
                            <fieldset class="form-label-group">
                                <input type="email" id="email-input" class="form-control" placeholder="contact@example.com" required="" name="email">
                                <label for="email-input">Email address</label>
                            </fieldset>
                            <hr>
                            <button type="submit" class="btn-gradient-primary btn-block my-1">Send password reset</button>
