		...
		<div class="content-wrapper">
			<div class="content-header row">
				<div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
					<h3 class="content-header-title mb-0 d-inline-block">Admin Settings</h3>
...
<div class="row">
	<h6 class="my-2">Update <?=$short?>/BTC exchange rate</h6>
	<div class="col-12">
		<?php printMessages($messages);?>
			<div class="card">
				<div class="card-content collapse show">
					<form class="form-horizontal form-purchase-token" 	action="process-admin-settings.php" method="POST" id="updaterateform">
						...
						<div class="card-body row">
							<div class="col-md-3 col-12">
								<fieldset class="form-label-group mb-0">
									<input class="form-control" id="ico-<?=$field?>" name="<?=$field?>" autofocus="" value="<?=$value?>">
									<label for="ico-<?=$field?>"><?=$field?></label>
								</fieldset>
							</div>
						...
						<div class="card-body row">
							<div class="col-md-3 col-12">
								<fieldset class="form-label-group mb-0">
									<input class="form-control" name="currency-rate-<?=$currency['short']?>" autofocus="" value="<?=$currency['rate']?>">
									<label>1.0 <?=$fullname?> in <?=$currency['fullname']?></label>
								</fieldset>
							</div>
							<div class="col-md-9 col-12 mb-1">
						...
						<div class="card-body row">
							<div class="col-md-3 col-12">
								<fieldset class="form-label-group mb-0">
									<input class="form-control" name="currency-requiredconf-<?=$currency['short']?>" autofocus="" value="<?=$currency['required_conf']?>">
									<label><?=$currency['fullname']?> required confirmations</label>
								</fieldset>
							</div>
							<div class="col-md-9 col-12 mb-1">
								Current value: <?=htmlspecialchars($currency['required_conf'])?>
							</div>
						</div>
						<hr>
